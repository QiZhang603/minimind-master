...
from trainer.tracker_utils import init_tracker
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tracker", type=str, default="swanlab", choices=["swanlab", "wandb"], help="实验跟踪后端")
    parser.add_argument("--wandb_entity", type=str, default=None, help="wandb的entity/team，可选")
    parser.add_argument("--wandb_proxy", type=str, default=None, help="wandb代理地址，如http://127.0.0.1:7890")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb = init_tracker(args, ckp_data, wandb_run_name)
